...
// Require lecturer or admin access
requireLecturerOrAdmin();

// Handle form submissions (existing logic remains unchanged)
$errors = [];
$success = '';
...
if (isset($_POST['update_quiz_settings']) && isLecturer()) {
    ...
    if ($min_questions < 10 || $min_questions > 30 || $max_questions < 10 || $max_questions > 30 || $min_questions > $max_questions) {
        ...
        $stmt->bind_param("iiiii", $_SESSION['user_id'], $min_questions, $max_questions, $min_questions, $max_questions);
        if ($stmt->execute()) {
...
<body class="bg-gray-50 min-h-screen font-['Inter']">
    ...
    <!-- Hero Section -->
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 py-16 mb-8">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl text-white/90">Create and manage quiz questions</p>
        </div>
    </div>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <?php foreach ($questions as $q): ?>
                                                <tr class="question-row">
                                                    ...
                                                    <?php if (isAdmin()): ?>
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= htmlspecialchars($q['lecturer_name']) ?></td>
                                                    <?php endif; ?>
